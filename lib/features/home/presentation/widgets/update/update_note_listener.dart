...
class UpdateNoteListener extends ConsumerWidget {
  const UpdateNoteListener({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    bool hasInitialized = false;

    ref.listen<AsyncValue<Unit>>(updateNoteNotifierProvider, (previous, next) {
      if (!hasInitialized) {
        hasInitialized = true;
        return;
      }
      ...
      next.when(
        ...
        data: (data) {
          ...
          AppCustomDialog.show(
            ...
            message: AppStrings.noteUpdated,
            okAction: () {},
          );
        },
